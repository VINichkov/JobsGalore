...
ActiveRecord::Schema.define(version: 20170125130039) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "carearone", force: :cascade do |t|
    t.string "title_job"
    t.text   "descriptions"
    t.string "type"
    t.string "category"
  ...
  create_table "jobs", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index "to_tsvector('english'::regconfig, (((((title)::text || ' '::text) || description) || ' '::text) || (career)::text))", name: "jobs_idx", using: :gin
  ...
  create_table "locations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index "to_tsvector('english'::regconfig, (((((suburb)::text || ' '::text) || (state)::text) || ' '::text) || (postcode)::text))", name: "locations_idx", using: :gin
  end
