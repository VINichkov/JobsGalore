class LinkedInClient
  ...
  def get_profile(token)
    ...
    if token
      url = URI.parse('https://api.linkedin.com/v2/me?fields=(id,email-address,first-name,last-name,headline,location,industry,picture-url,public-profile-url,summary,positions)')
